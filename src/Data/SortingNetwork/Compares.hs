...
{-
  ...
  TODO: we should probably have an extra module that is similar to vector-algorithms,
  this would allow us to verify different networks without having to do E2E testing
  through modules generated by TH.
